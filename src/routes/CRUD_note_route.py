from src.services.CRUD_note_service import fill_notes , fill_notes2, delete_notes, get_notes, modify_notes, modify_notes2
...
from src.schemas.note_schema import NoteCreateSchema, NoteGetSchema
